...
"                   one. The retired .refx reference had no such noise, its\n"
"                   design values having been computed once at build time.\n"
"                   Costs a second pass over the kept rows.\n"
...
"                   6-class conjunction admits 419. Every class still gets a\n"
"                   digit, so this stays ONE MRMP set with full context.\n"
"    --rescue-gap G  rescue on |beta_a - beta_b| >= G instead of on the band,\n"
"                   and exempt the pair's own classes from it. The gap is what\n"
...
"                   differently to loosening -- Macrophage|Monocyte gains 5.6x\n"
"                   where T.Cell.CD4|T.Cell.CD8 gains 1.9x -- so one threshold\n"
"                   over-relaxes the easy pairs before the starved ones have\n"
"                   enough. Read off a per-pair gap histogram in one pass.\n"
